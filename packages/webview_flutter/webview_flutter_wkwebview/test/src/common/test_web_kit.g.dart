...
class _TestWKWebViewHostApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is AuthenticationChallengeResponse) {
      ...
      buffer.putUint8(135);
      writeValue(buffer, value.encode());
    } else if (value is PWebHistory) {
      buffer.putUint8(136);
      writeValue(buffer, value.encode());
    } else if (value is PWebHistoryItem) {
      buffer.putUint8(137);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 136: 
        return PWebHistory.decode(readValue(buffer)!);
      case 137: 
        return PWebHistoryItem.decode(readValue(buffer)!);
      case 138: 
        return WKAudiovisualMediaTypeEnumData.decode(readValue(buffer)!);
      case 139: 
...
abstract class TestWKWebViewHostApi {
  ...
  static void setup(TestWKWebViewHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.getCopyBackForwardList', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.getCopyBackForwardList was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.getCopyBackForwardList was null, expected non-null int.');
          try {
            final PWebHistory? output = api.getCopyBackForwardList(arg_identifier!);
            return <Object?>[output];
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
