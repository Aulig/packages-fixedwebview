...
class PWebHistoryItem {
  ...
  static PWebHistoryItem decode(Object result) {
    result as List<Object?>;
    return PWebHistoryItem(
...
class PWebHistory {
  ...
  static PWebHistory decode(Object result) {
    result as List<Object?>;
    return PWebHistory(
      history: (result[0] as List<Object?>?)?.cast<PWebHistoryItem?>(),
...
class WKWebViewHostApi {
  ...
  Future<PWebHistory?> getCopyBackForwardList(int arg_identifier) async {
    const String channelName = 'dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.getCopyBackForwardList';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
    ...
    if (replyList == null) {
      ...
      return (replyList[0] as PWebHistory?);
    }
  }
}
