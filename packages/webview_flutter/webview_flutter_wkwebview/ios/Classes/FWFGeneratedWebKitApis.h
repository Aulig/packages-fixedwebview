...
@class FWFPWebHistoryItem;
@class FWFPWebHistory;
...
@interface FWFPWebHistoryItem : NSObject
...
@interface FWFPWebHistory : NSObject
...
@property(nonatomic, copy, nullable) NSArray<FWFPWebHistoryItem *> * history;
...
- (nullable FWFPWebHistory *)getCopyBackForwardListForWebViewWithIdentifier:(NSInteger)identifier error:(FlutterError *_Nullable *_Nonnull)error;
@end
