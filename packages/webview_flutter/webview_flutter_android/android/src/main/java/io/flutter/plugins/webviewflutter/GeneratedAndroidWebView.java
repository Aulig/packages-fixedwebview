...
public class GeneratedAndroidWebView {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class PWebHistoryItem {
    ...
    public void setOriginalUrl(@Nullable String setterArg) {
    ...
    public void setOffset(@Nullable Long setterArg) {
      this.offset = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setOriginalUrl(@Nullable String setterArg) {
        this.originalUrl = setterArg;
        return this;
      }
      ...
      public @NonNull Builder setOffset(@Nullable Long setterArg) {
        this.offset = setterArg;
        return this;
      }

      public @NonNull PWebHistoryItem build() {
        PWebHistoryItem pigeonReturn = new PWebHistoryItem();
        pigeonReturn.setOriginalUrl(originalUrl);
        pigeonReturn.setTitle(title);
        pigeonReturn.setUrl(url);
        pigeonReturn.setIndex(index);
        pigeonReturn.setOffset(offset);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(offset);
      return toListResult;
    }

    static @NonNull PWebHistoryItem fromList(@NonNull ArrayList<Object> list) {
      PWebHistoryItem pigeonResult = new PWebHistoryItem();
      ...
      Object offset = list.get(4);
      pigeonResult.setOffset((offset == null) ? null : ((offset instanceof Integer) ? (Integer) offset : (Long) offset));
      return pigeonResult;
    }
  }

  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class PWebHistory {
    /**List of all [WebHistoryItem]s. */
    private @Nullable List<PWebHistoryItem> history;

    public @Nullable List<PWebHistoryItem> getHistory() {
      return history;
    }

    public void setHistory(@Nullable List<PWebHistoryItem> setterArg) {
      this.history = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setHistory(@Nullable List<PWebHistoryItem> setterArg) {
        this.history = setterArg;
        return this;
      }
      ...
      public @NonNull PWebHistory build() {
        PWebHistory pigeonReturn = new PWebHistory();
        pigeonReturn.setHistory(history);
    ...
    ArrayList<Object> toList() {
      ArrayList<Object> toListResult = new ArrayList<Object>(2);
      toListResult.add(history);
      toListResult.add(currentIndex);
      return toListResult;
    }

    static @NonNull PWebHistory fromList(@NonNull ArrayList<Object> list) {
      PWebHistory pigeonResult = new PWebHistory();
      Object history = list.get(0);
      pigeonResult.setHistory((List<PWebHistoryItem>) history);
      Object currentIndex = list.get(1);
  ...
  private static class WebViewHostApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte) 128:
          return PWebHistory.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 129:
          return PWebHistoryItem.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 130:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof PWebHistory) {
        stream.write(128);
        writeValue(stream, ((PWebHistory) value).toList());
      } else if (value instanceof PWebHistoryItem) {
        stream.write(129);
        writeValue(stream, ((PWebHistoryItem) value).toList());
  ...
  public interface WebViewHostApi {
    ...
    @NonNull 
    PWebHistory getCopyBackForwardList(@NonNull Long instanceId);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewHostApi.getCopyBackForwardList", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number instanceIdArg = (Number) args.get(0);
                try {
                  PWebHistory output = api.getCopyBackForwardList((instanceIdArg == null) ? null : instanceIdArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
